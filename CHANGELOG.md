...
- **Spawning & Testing Commands**
  ...
  - Added a 4th optional argument to `/ahp spawn_all_bases_3D` called `[spacing_multiplier]` to manually expand or shrink the physical distance between the spawned hamsters.
