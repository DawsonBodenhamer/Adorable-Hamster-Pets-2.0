...
public class HamsterBreedingFurOverlayLayer extends GeoRenderLayer<HamsterEntity> {

    public HamsterBreedingFurOverlayLayer(GeoRenderer<HamsterEntity> entityRendererIn) {
    ...
    public void render(MatrixStack poseStack, HamsterEntity animatable, BakedGeoModel bakedModel, RenderLayer renderType,
        ...
        if (genome.breedingOverlayPattern() > 0 && genome.breedingOverlayPaletteId() != null) {
            ...
            Identifier overlayTexture = HamsterTextureUtil.getOrCreateDynamicTexture("overlays/fur_overlay_pattern/" + patternName, genome.breedingOverlayPaletteId());
