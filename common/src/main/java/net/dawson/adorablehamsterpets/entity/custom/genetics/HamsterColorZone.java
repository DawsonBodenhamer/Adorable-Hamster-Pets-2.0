...
/**
 * Defines 11 abstract color categories used for spawning environments and overlay exclusion rules.
...
public enum HamsterColorZone {
    ...
    ROSE("assets/adorablehamsterpets/textures/entity/hamster/jimcerberus/pearl_rose.png"),
