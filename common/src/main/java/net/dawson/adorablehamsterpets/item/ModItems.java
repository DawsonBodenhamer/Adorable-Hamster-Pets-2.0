...
public class ModItems {
    ...
    private static RegistrySupplier<Item> registerItem(String name, Supplier<Item> itemSupplier) {
        return ITEMS.register(new Identifier(AdorableHamsterPets.MOD_ID, name), itemSupplier);
    }
    ...
    private static Item createHamsterArmorTemplate(String materialName) {
        return new SmithingTemplateItem(
                ...
                List.of(new Identifier("minecraft", "item/empty_armor_slot_helmet")),                                                                 // Empty Base Slot Icon
                List.of(new Identifier("minecraft", "item/empty_slot_ingot"))                                                                         // Empty Additions Slot Icon
        ) {
            @Override
            public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
