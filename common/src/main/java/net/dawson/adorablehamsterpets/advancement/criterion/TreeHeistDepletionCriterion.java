...
public class TreeHeistDepletionCriterion extends AbstractCriterion<TreeHeistDepletionCriterion.Conditions> {
    private final Identifier id;

    public TreeHeistDepletionCriterion(Identifier id) {
        this.id = id;
    }
