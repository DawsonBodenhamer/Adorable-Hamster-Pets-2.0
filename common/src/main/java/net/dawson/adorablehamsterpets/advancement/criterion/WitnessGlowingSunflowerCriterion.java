...
public class WitnessGlowingSunflowerCriterion extends AbstractCriterion<WitnessGlowingSunflowerCriterion.Conditions> {
    private final Identifier id;

    public WitnessGlowingSunflowerCriterion(Identifier id) {
        this.id = id;
    }
