    ...
    public static void spawnDebugParticles(World world, BlockPos anchor, List<Long> leafLongs) {
        ...
        if (anchor != null) {
            for (int i = 0; i < 10; i++) { // 15 particles per tick
                ...
                serverWorld.spawnParticles(ParticleTypes.TRIAL_SPAWNER_DETECTION_OMINOUS, // TODO: Use WAX_ON on 1.20.1
                        x, y, z,
                        1, 0, 0, 0, 0);
            }
        }
        ...
        if (!leafLongs.isEmpty()) {
            ...
            for (int i = 0; i < particleCount; i++) {
                ...
                serverWorld.spawnParticles(ParticleTypes.TRIAL_SPAWNER_DETECTION, // TODO: Use WAX_OFF on 1.20.1
