...
public class EnUsGenerator extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.Provider registries,
        ...
        ConfigApiJava.buildTranslations(
                AhpRootConfig.class,
                ResourceLocation.fromNamespaceAndPath(AdorableHamsterPets.MOD_ID, "root"),
                "en_us",
                false,
                safeSingleWriter
        );
        ...
        ConfigApiJava.buildTranslations(
                ...
                ResourceLocation.fromNamespaceAndPath(AdorableHamsterPets.MOD_ID, "supporter_perks"),
                "en_us",
                false,
                safeSingleWriter
        );
        ...
        ConfigApiJava.buildTranslations(
                AhpMainConfig.class,
                ResourceLocation.fromNamespaceAndPath(AdorableHamsterPets.MOD_ID, "main"),
                "en_us",
                false,
                safeSingleWriter
        );
        ...
        ConfigApiJava.buildTranslations(
                AhpItemConfig.class,
                ResourceLocation.fromNamespaceAndPath(AdorableHamsterPets.MOD_ID, "items"),
                "en_us",
                false,
                safeSingleWriter
        );
        ...
        ConfigApiJava.buildTranslations(
                AhpUiConfig.class,
                ResourceLocation.fromNamespaceAndPath(AdorableHamsterPets.MOD_ID, "ui"),
                "en_us",
                false,
                safeSingleWriter
        );
        ...
        ConfigApiJava.buildTranslations(
                ...
                ResourceLocation.fromNamespaceAndPath(AdorableHamsterPets.MOD_ID, "worldgen"),
                "en_us",
                false,
                safeSingleWriter
        );
