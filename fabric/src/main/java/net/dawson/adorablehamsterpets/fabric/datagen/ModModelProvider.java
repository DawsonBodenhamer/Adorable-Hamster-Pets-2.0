...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.blockStateCollector.accept(
                BlockStateModelGenerator.createSingletonBlockState(
                        ...
                        new Identifier(AdorableHamsterPets.MOD_ID, "block/acorn_crate")
                )
        );
        blockStateModelGenerator.blockStateCollector.accept(
                BlockStateModelGenerator.createSingletonBlockState(
                        ModBlocks.CUCUMBER_CRATE.get(),
                        new Identifier(AdorableHamsterPets.MOD_ID, "block/cucumber_crate")
                )
        );
        blockStateModelGenerator.blockStateCollector.accept(
                BlockStateModelGenerator.createSingletonBlockState(
                        ModBlocks.GREEN_BEANS_CRATE.get(),
                        new Identifier(AdorableHamsterPets.MOD_ID, "block/green_beans_crate")
                )
        );
        blockStateModelGenerator.blockStateCollector.accept(
                BlockStateModelGenerator.createSingletonBlockState(
                        ModBlocks.HAMSTER_FOOD_MIX_CRATE.get(),
                        new Identifier(AdorableHamsterPets.MOD_ID, "block/hamster_food_mix_crate")
                )
        );
    }
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        for (RegistrySupplier<Item> bedItemSupplier : ModItems.HAMSTER_BED_ITEMS.values()) {
            itemModelGenerator.register(bedItemSupplier.get(), new Model(
                    Optional.of(new Identifier(AdorableHamsterPets.MOD_ID, "item/hamster_bed")),
                    Optional.empty()
            ));
        }
        ...
        itemModelGenerator.register(ModItems.ACORN_CRATE.get(), new Model(
                Optional.of(new Identifier(AdorableHamsterPets.MOD_ID, "block/acorn_crate")),
                Optional.empty()
        ));
        itemModelGenerator.register(ModItems.CUCUMBER_CRATE.get(), new Model(
                Optional.of(new Identifier(AdorableHamsterPets.MOD_ID, "block/cucumber_crate")),
                Optional.empty()
        ));
        itemModelGenerator.register(ModItems.GREEN_BEANS_CRATE.get(), new Model(
                Optional.of(new Identifier(AdorableHamsterPets.MOD_ID, "block/green_beans_crate")),
                Optional.empty()
        ));
        itemModelGenerator.register(ModItems.HAMSTER_FOOD_MIX_CRATE.get(), new Model(
                Optional.of(new Identifier(AdorableHamsterPets.MOD_ID, "block/hamster_food_mix_crate")),
                Optional.empty()
        ));
    }
    ...
    private void generateHamsterBedVariantModels(BlockStateModelGenerator generator) {
        ...
        Identifier baseModelId = new Identifier(AdorableHamsterPets.MOD_ID, "block/hamster_bed");

        for (String wood : woodTypes) {
            Identifier variantModelId = new Identifier(AdorableHamsterPets.MOD_ID, "block/hamster_bed_" + wood);
            Identifier particleTexture = new Identifier(AdorableHamsterPets.MOD_ID, "block/hamster_bed_" + wood);
